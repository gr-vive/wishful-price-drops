...
export function useItems() {
  ...
  const addBy = async (input: CreatePayloadInput) => {
    ...
    const skeletonItem: ItemDTO = {
      ...
      links: input.links || [],
      initial_price: undefined, // Will be set by API on first fetch
    ...
    const demoItems: ItemDTO[] = [
      {
        ...
        current_price: 51.77,
        target_price: 52.0,
        lowest_price_today: 50.99,
        lowest_price_url: 'https://books.toscrape.com/catalogue/a-light-in-the-attic_1000/index.html',
        lowest_price_store: 'Books To Scrape',
      ...
      },
      {
        ...
        current_price: 53.74,
        target_price: 53.0,
        lowest_price_today: 52.80,
        lowest_price_url: 'https://books.toscrape.com/catalogue/tipping-the-velvet_999/index.html',
        lowest_price_store: 'Books To Scrape',
      ...
      },
      {
        ...
        links: [],
        initial_price: 1099.0,
        current_price: 999.0,
        lowest_price_today: 949.0,
        lowest_price_url: 'https://example.com/iphone-15-pro',
        lowest_price_store: 'Tech Store UK',
